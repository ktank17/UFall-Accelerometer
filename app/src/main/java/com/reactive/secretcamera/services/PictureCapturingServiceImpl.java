...
public class PictureCapturingServiceImpl extends APictureCapturingService {
    ...
    static final int MAX_PICTURES = 25;
    int count=0;
    ...
    public void startCapturing(final PictureCapturingListener listener) {
        ...
        try {
            ...
            if (cameraIds.length > 0) {
                this.currentCameraId = cameraIds[0];
                openCamera();
            } else {
                //No camera detected!
    ...
    private void takePicture() throws CameraAccessException {
        ...
        final ImageReader reader = ImageReader.newInstance(width, height, ImageFormat.JPEG, 25);
        ...
        cameraDevice.createCaptureSession(outputSurfaces, new CameraCaptureSession.StateCallback() {
                    ...
                    public void onConfigured(@NonNull CameraCaptureSession session) {
                        try {
                            session.setRepeatingRequest(captureBuilder.build(),captureListener,null);
                        } catch (final CameraAccessException e) {
